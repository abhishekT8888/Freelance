    ...
    <div>
      ...
      <div className="w-full md:w-1/2 flex justify-center">
        <img
          ...
          className="rounded-lg shadow-lg max-w-full h-auto transition-transform duration-500 hover:scale-105"
        />
      </div>
      ...
      <div className="w-full md:w-1/2 mt-8 md:mt-0 md:pl-8 text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start">
          <img
            ...
            className="w-20 h-20 md:mr-6 mb-4 md:mb-0 transition-transform duration-500 hover:scale-110"
          />
          <div className="flex flex-col items-center md:items-start">
            ...
            >
              <button className="bg-red-600 text-white py-2 px-6 rounded shadow hover:bg-red-700 transition-transform duration-300 hover:scale-110">
                Download Brochure
              </button>
            </a>
          </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 mt-20 p-5">
      <div className="flex flex-col justify-center items-center gap-5">
        <img
          ...
          className="bg-red-700 rounded-full p-6 object-cover transition-transform duration-500 hover:scale-110"
        />
        <h1 className="text-black text-4xl font-normal font-monda">
          4,000+
        </h1>
        <h2 className="text-xl font-monda text-gray-600">
      ...
      <div className="flex flex-col justify-center items-center gap-5">
        <img
          ...
          className="bg-red-700 rounded-full p-6 transition-transform duration-500 hover:scale-110"
        />
        <h1 className="text-black text-4xl font-normal font-monda">
          3,500+
        </h1>
        <h2 className=" text-gray-600 text-xl font-monda">
